  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <header className="bg-blue-700 px-4 py-6 text-center shadow-md">
        ...
        <p className="text-blue-200 text-sm mt-1">Encontre um abrigo disponível perto de você</p>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        {carregando ? (
          ...
          <p className="text-center text-gray-500 mt-8">Nenhum abrigo cadastrado no momento.</p>
        ) : (
            ...
            {abrigos.map((abrigo) => (
              <div
                ...
                className={`bg-white rounded-xl shadow-sm p-5 border-l-4 ${
                  abrigo.status === 'disponivel' ? 'border-green-500' : 'border-red-500'
                }`}
              >
                <div className="flex justify-between items-start">
                  <h2 className="text-lg font-semibold text-slate-800">{abrigo.nome}</h2>
